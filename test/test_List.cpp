...
TEST(List, can_correctly_get_data)
{
    ...
    l.push_back(3);
    l.push_back(4);
    EXPECT_EQ(l.getData(1), 3);
    EXPECT_EQ(l.getData(2), 4);
}
...
TEST(List, can_correctly_equalize)
{
    ...
    l1.push_back(5);
    l2 = l1;
    EXPECT_EQ(l2.getData(1), 3);
    EXPECT_EQ(l2.getData(2), 5);
}
